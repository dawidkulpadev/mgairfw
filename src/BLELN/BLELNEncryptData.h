...
public:
    BLELNEncryptData() = default;
    ~BLELNEncryptData();

    BLELNEncryptData(const BLELNEncryptData&) = delete;
    BLELNEncryptData& operator=(const BLELNEncryptData&) = delete;
    BLELNEncryptData(BLELNEncryptData&&) = delete;
    BLELNEncryptData& operator=(BLELNEncryptData&&) = delete;

    bool makeServerKeys(); // Initialize with new server keys
    bool deriveSessionKey(const uint8_t *clientPub65,
