...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_MGAIR_V3, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_MGAIR_V3_NRF52840, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_BUFFER_SIZE, 256);
